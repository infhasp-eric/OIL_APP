...
public class RcListAdapter extends BaseAdapter {
	...
	public RcListAdapter(Context context, List<Map<String, Object>> listItems) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			// 获取list_item布局文件的视图
			convertView = listContainer.inflate(R.layout.rc_list_layout, null);
			// 获取控件对象
			...
			listItemView.r_month = (TextView) convertView
					.findViewById(R.id.r_month);
		...
		listItemView.valve_name.setText((String) listItems.get(position).get(
				"jinzhan"));
		listItemView.r_month.setText((String) listItems.get(position).get(
				"r_month"));
